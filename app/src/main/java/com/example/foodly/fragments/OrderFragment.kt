...
import com.example.foodly.adapters.HistoryAdapter
...
class OrderFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        details = this.requireActivity().getSharedPreferences("details",Context.MODE_PRIVATE)
                ...
                val jsonreq = object : JsonObjectRequest(
                    ...
                    Response.Listener {
                        if(it.getJSONObject("data").getBoolean("success")){
                            ...
                            recl_view.adapter = HistoryAdapter(activity as Context,list)
